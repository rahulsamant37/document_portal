## Loading the enviroment variables and configuration
import os
import sys
...
## Initalizing the LangChain Libraries
from langchain_google_genai import ChatGoogleGenerativeAI, GoogleGenerativeAIEmbeddings

## Initalizing the Custom Libraries
...
class ModelLoader:
    ...
    def _validate_env(self):
        ...
        if missing:
            ...
            raise DocumentPortalException("Missing environment variables")
